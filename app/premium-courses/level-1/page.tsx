            ...
            <header className="sticky top-20 z-50 bg-bg-card/80 backdrop-blur-xl border-b border-border px-6 py-4 shadow-2xl">
                <div className="max-w-7xl mx-auto flex items-center justify-between">
                    ...
                    <div className="flex items-center gap-3">
                        ...
                        <Link
                            href="/"
                            className="p-2.5 rounded-xl bg-bg-secondary border border-border hover:bg-accent-gold/10 transition-all text-text-secondary hover:text-accent-gold"
                        >
                ...
                <AnimatePresence mode="wait">
                    {activeTab === 'study' ? (
                        ...
                        >
                            ...
                            {/* Main Content Card */}
                            <div className="bg-bg-card border border-accent-gold/20 rounded-[40px] p-8 md:p-12 shadow-[0_0_50px_rgba(0,0,0,0.3)] relative overflow-hidden group">
                        ...
                        >
                            {!showResults ? (
                                <div className="space-y-8">
                                    ...
                                    {/* Question Card */}
                                    <div className="bg-bg-card border border-accent-gold/20 rounded-[40px] p-8 md:p-10 shadow-2xl relative">
                                                ...
                                                return (
                                                    <button
                                                        ...
                                                        className={`w-full p-5 rounded-2xl font-bold text-left transition-all relative overflow-hidden group border-2 ${isSelected
                                                            ...
                                                            : 'bg-bg-secondary border-border text-text-secondary hover:border-accent-gold/50 hover:text-text-primary'
                                                            }`}
                                                    >
                                ...
                                <motion.div
                                    ...
                                    className="bg-bg-card border-2 border-accent-gold rounded-[40px] p-12 text-center shadow-[0_0_80px_rgba(212,175,55,0.15)]"
                                >
                                    ...
                                    <div className="flex flex-col sm:flex-row justify-center gap-4">
                                        <button
                                            onClick={startQuiz}
                                            className="px-10 py-4 bg-bg-secondary hover:bg-bg-card rounded-2xl font-bold transition-all border border-border"
                                        >
                                            Retake Quiz
                                        </button>
                                        <Link
